 ...
 * limitations under the License.
 */
const Ao=new bo(Pi.comparator);function _o(){return Ao}const ko=new bo(Pi.comparator);function No(){return ko}const Do=new bo(Pi.comparator),xo=new So(Pi.comparator);function Ro(...t){let e=xo;for(const n of t)e=e.add(n);return e}const Lo=new So(ui);function Oo(){return Lo}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Po{constructor(t,e,n,s,i){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,e){const n=new Map;return n.set(t,Mo.createSynthesizedTargetChangeForCurrentChange(t,e)),new Po(fi.min(),n,Oo(),_o(),Ro())}}class Mo{constructor(t,e,n,s,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,e){return new Mo(Ti.EMPTY_BYTE_STRING,e,Ro(),Ro(),Ro())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dc{constructor(t,e){this.pi={},this.overlays={},this.Nn=new ai(0),this.xn=!1,this.xn=!0,this.referenceDelegate=t(this),this.Un=new Nc(this),this.indexManager=new ec,this.qn=function(t){return new _c(t)}((t=>this.referenceDelegate.Ii(t))),this.O=new Ja(e),this.Kn=new Tc(this.O)}start(){return Promise.resolve()}shutdown(){return this.xn=!1,Promise.resolve()}get started(){return this.xn}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new Ic,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.pi[t.toKey()];return n||(n=new Ac(e,this.referenceDelegate),this.pi[t.toKey()]=n),n}getTargetCache(){return this.Un}getRemoteDocumentCache(){return this.qn}getBundleCache(){return this.Kn}runTransaction(t,e,n){Ks("MemoryPersistence","Starting transaction:",t);const s=new xc(this.Nn.next());return this.referenceDelegate.Ei(),n(s).next((t=>this.referenceDelegate.Ti(s).next((()=>t)))).toPromise().then((t=>(s.raiseOnCommittedEvent(),t)))}Ai(t,e){return Ga.or(Object.values(this.pi).map((n=>()=>n.containsKey(t,e))))}}class xc extends za{constructor(t){super(),this.currentSequenceNumber=t}}class Rc{constructor(t){this.persistence=t,this.Ri=new Sc,this.Pi=null}static bi(t){return new Rc(t)}get vi(){if(this.Pi)return this.Pi;throw Ws()}addReference(t,e,n){return this.Ri.addReference(n,e),this.vi.delete(n.toString()),Ga.resolve()}removeReference(t,e,n){return this.Ri.removeReference(n,e),this.vi.add(n.toString()),Ga.resolve()}markPotentiallyOrphaned(t,e){return this.vi.add(e.toString()),Ga.resolve()}removeTarget(t,e){this.Ri.si(e.targetId).forEach((t=>this.vi.add(t.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next((t=>{t.forEach((t=>this.vi.add(t.toString())))})).next((()=>n.removeTargetData(t,e)))}Ei(){this.Pi=new Set}Ti(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Ga.forEach(this.vi,(n=>{const s=Pi.fromPath(n);return this.Vi(t,s).next((t=>{t||e.removeEntry(s,fi.min())}))})).next((()=>(this.Pi=null,e.apply(t))))}updateLimboDocument(t,e){return this.Vi(t,e).next((t=>{t?this.vi.delete(e.toString()):this.vi.add(e.toString())}))}Ii(t){return 0}Vi(t,e){return Ga.or([()=>Ga.resolve(this.Ri.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ai(t,e)])}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
//# sourceMappingURL=171.e3865689.js.map